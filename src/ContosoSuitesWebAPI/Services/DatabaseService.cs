...
public class DatabaseService : IDatabaseService
{
     ...
     public async Task<IEnumerable<Booking>> GetBookingsMissingHotelRooms()
     {
         ...
         using var conn = new SqlConnection(
                 connectionString: Environment.GetEnvironmentVariable("SQLAZURECONNSTR_ContosoSuites") ?? Environment.GetEnvironmentVariable("dbconnectionstring")
         );
         conn.Open();
   ...
   [KernelFunction]
    ...
    /// </summary>
     [KernelFunction]
     [Description("Get bookings for a hotel with minimum date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate( [Description("The ID of the hotel")] int hotelId, [Description("The minimum date")] DateTime dt)
    {
